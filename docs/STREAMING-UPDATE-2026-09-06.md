...
Düzeltme sonrası [CI çalışması](https://github.com/yahya308/screen-share-frontend/actions/runs/34113544397) başarılı; native ekran yakalama adımı dahil. Canlı dosyaların yerel SHA-256 değerleriyle eşleştiği doğrulandı. Canlı TURN TLS medya testi 45/45 geçti (`build/capture-fix-live/smoke-tls-ready.log`). Geç katılım kontrolü iki alıcı oluşana kadar en fazla 15 saniye bekler; önceki sabit dört saniye canlı ağda erken ölçüme yol açabiliyordu. Backend ve TURN servisleri bu düzeltme için yeniden başlatılmadı.
